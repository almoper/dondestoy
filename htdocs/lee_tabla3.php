<HTML>
	<HEAD>
	<TITLE>Visualización de ruta UPS</title>
	</HEAD>
	<BODY>
<?php 
 ...
 /*** a new dom object ***/ 
    ...
    {    	
      ...
      $cols = $row->getElementsByTagName('td'); 
    	...
    	if ( ($estado == 'ESCANEO LLEGADA' || 
    				$estado == 'ESCANEO SALIDA' ||
    				$estado == 'LISTO PARA ENTREGA') && $destino != '' && $destino != $destino_anterior)
    	{
        /*** echo the values ***/ 
/*
...
*/
    ...
    echo '<CENTER>El paquete está hoy en: <B>' . $hoy . ' (' . $estado_actual . ')';
    echo '<br><br>';
    echo '<A HREF="' . $cadena . '">Visualiza ruta ...</A>';
    echo '<br><br>';
    echo '<A HREF="' . "http://wwwapps.ups.com/WebTracking/processRequest?HTMLVersion=5.0&Requester=NES&AgreeToTermsAndConditions=yes&loc=es_ES&tracknum=1Z7F546F6842196403" . '">Detalle de ruta ...</A>';
