...
function Inicializa(){
    ...
    if (GBrowserIsCompatible()) {
      ...
      map.setMapType(G_SATELLITE_MAP);
			...
			escuchador2 = GEvent.addListener(map, 'mousemove', function(latlng) {
				document.getElementById("coordenadas").value = redondear(latlng.lat(), 5) + ',' + redondear(latlng.lng(), 5);  // toUrlValue();
				return;});
    }
}
